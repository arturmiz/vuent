    ...
    <vnt-tabs>
      ...
      <vnt-tab label="Tab 2">
        <p>
          ...
          pede cursus vitae, ultricies.
        </p>
      </vnt-tab>
      <vnt-tab label="Tab 3">
        <p>
          Quisque lorem tortor fringilla sed, vestibulum id, eleifend justo vel bibendum sapien massa ac turpis faucibus orci
...
<script>
import { VntTabs } from '../../../src/components';
